...
export const outlinedButtonClassName =
  'border text-purple-primary border-purple-primary disabled:hover:bg-white focus:bg-purple-focus-light hover:bg-purple-primary-disabled disabled:border-purple-primary-outlined-disabled disabled:text-purple-primary-outlined-disabled'
